...
export const metadata: Metadata = {
  title: "About Angel Metal & Alloys | SS Fittings Manufacturer Since 2007",
  description:
    "Angel Metal & Alloys, established 2007, is an Ahmedabad-based manufacturer and exporter of Stainless Steel pipe fittings, flanges, and forged components. 15-20 MT/month capacity, 30+ countries.",
...
const timeline = [
  { year: "2007", title: "Foundation", desc: "Angel Metal & Alloys was established by Mahendra Mehta in Ahmedabad with a vision to manufacture world-class SS pipe fittings." },
      ...
      <section className="bg-gradient-navy py-20 relative overflow-hidden">
        ...
        <div className="section-container relative">
          ...
          <p className="text-silver/70 text-lg max-w-2xl leading-relaxed">
            ...
            Stainless Steel pipe fittings, flanges, and forged components from Ahmedabad, 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                ...
                <p>
                  ...
                  range of SS pipe fittings and flanges conforming to international standards 
            ...
            <div className="bg-brand-bg rounded-3xl p-8">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-6">
                With over 17 years in the stainless steel industry, Mahendra Mehta has built 
          ...
          <div className="mt-20 text-center bg-navy rounded-3xl p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-silver/70 mb-8 max-w-xl mx-auto">
                Join 30+ countries that trust Angel Metal & Alloys for their SS pipe fittings and flanges.
              </p>
