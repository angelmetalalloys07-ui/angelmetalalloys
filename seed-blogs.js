...
const posts = [
  {
    slug: 'ss-304-vs-ss-316l-pipe-fittings-grade-selection-guide',
    title: 'SS 304 vs SS 316L Pipe Fittings: Complete Grade Selection Guide for Engineers',
    excerpt: 'Choosing the wrong stainless steel grade costs money, causes failures, and risks shutdowns. This definitive guide explains when to use SS 304, SS 316, SS 316L, and Duplex steel in pipe fittings — with real application examples from pharma, oil & gas, and chemical industries.',
    content: `# SS 304 vs SS 316L Pipe Fittings: Complete Grade Selection Guide for Engineers
...
*Angel Metal & Alloys, B-917 Sun West Bank, Ahmedabad – 380013, Gujarat, India*`,
    author: 'Angel Metal & Alloys — Technical Team',
    published: true,
    meta_title: 'SS 304 vs SS 316L Pipe Fittings Grade Selection Guide | Angel Metal Ahmedabad',
    meta_description: 'Complete engineer\'s guide to choosing SS 304, SS 316, SS 316L, or Duplex for pipe fittings and flanges. Industry-specific recommendations for pharma, chemical, oil & gas. By Angel Metal & Alloys, Ahmedabad.'
  },
  {
    slug: 'asme-b16-5-flange-pressure-class-selection-guide',
    title: 'ASME B16.5 Flange Pressure Class Guide: How to Choose Class 150, 300, 600, 900, 1500 or 2500',
    excerpt: 'Specifying the wrong pressure class flange is one of the most dangerous — and expensive — mistakes in piping engineering. This practical guide explains ASME B16.5 pressure classes, how temperature affects ratings, and a step-by-step selection method used by plant engineers in India and globally.',
    content: `# ASME B16.5 Flange Pressure Class Guide: How to Choose Class 150, 300, 600, 900, 1500 or 2500
...
*Angel Metal & Alloys, B-917 Sun West Bank, Opp Rajasthan Hospital, Ahmedabad – 380013, Gujarat, India. Est. 2007. Exporting to 30+ countries.*`,
    author: 'Angel Metal & Alloys — Technical Team',
    published: true,
    meta_title: 'ASME B16.5 Flange Pressure Class Selection Guide: 150 to 2500 | Angel Metal Ahmedabad',
    meta_description: 'Practical ASME B16.5 flange pressure class selection guide — Class 150, 300, 600, 900, 1500, 2500. Includes temperature de-rating tables, step-by-step selection method, and industry applications. By Angel Metal & Alloys, Ahmedabad.'
  }
];
